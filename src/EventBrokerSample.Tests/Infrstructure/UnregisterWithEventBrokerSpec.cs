...
namespace EventBrokerSample.Tests.Infrstructure
{
	...
	[TestFixture]
	public class when_the_UnregisterWithEventBroker_concern_is_applied
	{
		...
		public void it_should_regsiter_the_object_in_the_event_register()
		{
			...
			register.Verify(r => r.Unregister(component));
		}

		private IDecommissionConcern CreateSut()
		{
			return new UnregisterWithEventBroker(register.Object);
		}
	}
}